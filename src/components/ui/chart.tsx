...
// Add these type definitions for Recharts
...
type ChartPayload = readonly ChartPayloadItem[] | undefined;
...
function ChartTooltipContent({
  ...
  const typedPayload = payload as ChartPayload;
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {typedPayload.map((item:any, index:any) => {
